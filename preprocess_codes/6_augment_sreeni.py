...
images_path="D:\IEEE_GRSS_IADFTC_Contest2014_full_data_set\\tiffs\_train_test\\train\\train\swir\\" #path to original images
masks_path = "D:\IEEE_GRSS_IADFTC_Contest2014_full_data_set\\tiffs\_train_test\\train\\train\\vis\\"
img_augmented_path="D:\IEEE_GRSS_IADFTC_Contest2014_full_data_set\\tiffs\_train_test\\train\\augmented\\swir\\" # path to store aumented images
msk_augmented_path="D:\IEEE_GRSS_IADFTC_Contest2014_full_data_set\\tiffs\_train_test\\train\\augmented\\vis\\" # path to store aumented images
...
while i<=images_to_generate: 
    ...
    original_image = np.swapaxes(original_image, 2,0)
    original_image = np.swapaxes(original_image, 1,0)
...
#     print(i)
    ...
    new_image_path= "%s/aug_img_%s.tiff" %(img_augmented_path, str(i).zfill(4))
    new_mask_path = "%s/aug_msk_%s.tiff" %(msk_augmented_path, str(i).zfill(4))   #Do not save as JPG
    transformed_image = np.swapaxes(transformed_image, 2,0)
