...
x=io.imread('D:\IEEE_GRSS_IADFTC_Contest2014_full_data_set\\tiffs\\vis.tif')
print(x.shape)
...
opath = 'D:\IEEE_GRSS_IADFTC_Contest2014_full_data_set\\tiffs\patched_vis\\'

patches = patchify(img,(64,64,3),step=64-8)
print(patches.shape)
